...
python3 results_processors/pipeline_algorithm_comparator.py -p features normalizer -ip ../results/pipeline/features_normalizer -ia ../results/algorithm -o ../results/comparison
